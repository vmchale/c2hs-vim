...
syntax keyword c2hsKw enum as const pointer newtype nocode import type get set call unsafe pure fun context nonGNU sizeof alignof define call offsetof class typedef default deriving
